									...
									<div class="card">
										<div class="card-body"> 
											...
											<div class="table-responsive m-t-40">												
												...
												?>  
												<a class="btn btn-success" data-toggle="modal" data-target="#addUser">Add User</a>
												<table id="tableData" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
													...
													?>
														<tr>
															...
															<td>
																<a class="btn btn-success" data-toggle="modal" data-target="#userModal<?php echo $user->id_user; ?>">Edit</a>
																&nbsp;
																<a class="btn btn-success" data-toggle="modal" data-target="#gantiPassword<?php echo $user->id_user; ?>">Ganti Password</a>
															</td>
														</tr>														
													  <?php }
														}
...
<?php 
	if(isset($data_user)){
		foreach($data_user as $user){ 
?>
<?php echo form_open_multipart('user/save_user'); ?> 
<div class="modal fade bs-example-modal-lg" id="userModal<?php echo $user->id_user; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
					...
					<input type="hidden" class="form-control" name="kode_siswa" value="<?php echo $user->kode_siswa; ?>" required>
					<div class="form-group">
						<label for="recipient-name" class="control-label">Username</label>
						<input type="text" class="form-control" name="username" value="<?php echo $user->username; ?>" required>
					</div>
					<div class="form-group">
						<label for="message-text" class="control-label">Level User</label>
						<select class="custom-select col-12" id="inlineFormCustomSelect" name="level_role" placeholder="Chose Status" required>       
							<option value="<?php echo $user->level_role; ?>"><?php echo $user->nama_role; ?></option>  
                            <?php foreach($data_role as $role){  ?>
                            <option value="<?php echo $role->level_role; ?>"><?php echo $role->nama_role; ?></option>
							<?php } ?>
                        </select> 
					</div>
					<div class="form-group">
...
<div class="modal fade bs-example-modal-lg" id="addUser" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
...
<?php 
	if(isset($data_user)){
		foreach($data_user as $user){ 
?>
<?php echo form_open_multipart('user/ganti_password'); ?> 
